...
@export var delay_antes: float = 0.5  # tiempo antes de iniciar el fade-in
...
func _ready() -> void:
	...
	# Aseguramos que el material sea único y comience transparente
...
func aparecer_mesh() -> void:
	print("✨ Iniciando fade-in del nuevo mesh...")
	apareciendo = true
	...
	audio.play()  # reproducir audio al comenzar a aparecer
